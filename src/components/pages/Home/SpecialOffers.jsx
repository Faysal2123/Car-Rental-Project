        ...
        <div className="container mx-auto px-4 py-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
                ...
                >
                    ...
                    <p className="text-lg mb-6">Enjoy your weekend getaway with a special discount on our premium car rentals. Book now and make memories that last!</p>
                ...
                >
                    ...
                    <p className="text-lg mb-6">Drive in style this holiday season with unbeatable pricing. Our fleet of luxury cars is waiting for you!</p>
                ...
                >
                    ...
                    <p className="text-lg mb-6">Make the most of your weekend with an exclusive 20% discount. Don’t miss out on this amazing offer!</p>
